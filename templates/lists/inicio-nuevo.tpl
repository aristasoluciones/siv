...
<table class="table table-striped table-bordered table-hover" id="sample_3">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align:center"><button href="javascript:void(0)" onClick="ViewTramite('{$item.id}')" class="btnInfo"> Ver</button></td>
			<td><div align="center">
				<!--onclick="window.location.href='{$WEB_ROOT}/new/id/{$item.id}'--> 
				<button  onClick="addTramite('{$item.id}')" class="btnInfo" style="width:150px"><img src="{$WEB_ROOT}/images/mas.png" style="width:10%"> Agregar Tramite</button>
