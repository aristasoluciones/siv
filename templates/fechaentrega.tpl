...
<section id="headline">
    <div class="container"><div class="container iniciar">
      <p align="right"> <Center><h1>Tiempo estimado de entrega</h1></center></p>	  
    </div>
...
<!-- otro-->
    <section class="container page-content" >
      <hr class="vertical-space2">        
        ...
        <center><p><span class="highlight1">Fecha de salida del Producto:</span><span class="highlight2"></span>{$item.fecha}<span class="highlight1">Fecha Posible de entrega de producto:</span><span class="highlight2"></span>{$item.fecha}</p></center>
