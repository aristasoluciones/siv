          ...
          <div class="tab-content">
            <article class="tab-pane active" id="lA">
              <div class="two_third"> <br>
                <h5><strong>CAPTACIÓN DE CLIENTES</strong></h5>
                <p>El sistema a permite la captación de clientes, a través del trabajo constante, permitiendo realizar campañas específicas en los momentos puntuales.</p>
                <div class="one_half">
